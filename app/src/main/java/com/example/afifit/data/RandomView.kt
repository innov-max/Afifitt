...
import com.example.afifit.data.CardPopular
...
object RandomView {
    ...
    init {
        ...
        cardPopularList = listOf(
            CardPopular("Cbum", R.drawable.anne, "https://www.instagram.com/cbum/"),
            CardPopular("Tibo Inshape", R.drawable.anne, "https://www.youtube.com/user/OutLawzFR"),
            CardPopular("Arnold", R.drawable.anne, "https://fr.wikipedia.org/wiki/Arnold_Schwarzenegger"),
            CardPopular("Mike Mentzers", R.drawable.anne, "https://fr.wikipedia.org/wiki/Mike_Mentzer")
        )
